...
class EditOfferDialog extends StatefulWidget {
  final Offer offer;
  final Function(String name, int baseDurationMonths, int additionalDays, double totalAmount, String description, bool isActive) onEdit;
...
class _EditOfferDialogState extends State<EditOfferDialog> {
  ...
  late final TextEditingController _additionalDaysController;
  ...
  void initState() {
    ...
    _additionalDaysController = TextEditingController(text: widget.offer.additionalDays.toString());
    _amountController = TextEditingController(text: widget.offer.totalAmount.toString());
    _descriptionController = TextEditingController(text: widget.offer.description);
    _selectedDuration = widget.offer.baseDurationMonths;
    ...
    return AlertDialog(
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  Text(
                    AppLocalizations.of(context).membershipStatus,
                    style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 16,
                    ),
      ...
      actions: [
        ...
        ElevatedButton(
          ...
          child: Text(AppLocalizations.of(context).editOffer),
        ),
      ],
    );
  }
